...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col relative overflow-hidden selection:bg-cyan-500/30">
      ...
      {/* Static Background glow effects (optimized for performance) */}
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-indigo-500/10 blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-20%] w-[40%] h-[40%] rounded-full bg-fuchsia-500/10 blur-[120px] pointer-events-none" />
      <div className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[60%] h-[20%] rounded-full bg-cyan-500/5 blur-[120px] pointer-events-none" />
